...
wallpapersDir="/home/chie/wallpapers"
...
while true; do
    ...
    awww img "$selectedWallpaper" --resize stretch --transition-type any --transition-duration 1 --outputs DP-1
    ...
    # Actualiza el fondo de pantalla usando el comando swww img
    awww img "$selectedWallpaper" --resize stretch --transition-type any --transition-duration 1 --outputs HDMI-A-1
