...
local menu        = "nwg-drawer -mb 10 -ml 10 -mr 10 -mt 10 -nocats -closebtn right"
...
hl.on("hyprland.start", function () 
  ...
  hl.exec_cmd("killall xdg-desktop-portal-hyprland; killall xdg-desktop-portal; /usr/lib/xdg-desktop-portal-hyprland & sleep 2; /usr/lib/xdg-desktop-portal &")
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = "rgba(60,230,250,1)",
            inactive_border = "rgba(60,230,250,0.5)",
        },
...
hl.workspace_rule({ workspace = "12", monitor = "HDMI-A-1", default = true })
hl.workspace_rule({ workspace = "13", monitor = "HDMI-A-1", default = true })
hl.workspace_rule({ workspace = "14", monitor = "HDMI-A-1", default = true })
hl.workspace_rule({ workspace = "15", monitor = "HDMI-A-1", default = true })
...
hl.bind(mainMod .. " + F4", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
hl.bind(mainMod .. " + G", hl.dsp.exec_cmd("~/.config/muysua/lanzar_bochica_core.sh"))
...
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("XDG_CURRENT_DESKTOP=sway flameshot full"))
...
hl.window_rule({
    match = {initial_title = "Control de volumen"},
    float = true,
    size = {854, 480},
    center = true,
})
...
hl.window_rule({
    match = {initial_title = "Monitor del sistema"},
    float = true,
    size = {1280, 720},
    center = true,
})
...
hl.window_rule({
    match = {initial_title = "Destacados"},
    float = true,
    size = {1366, 800},
    center = true,
})
