...
## Paquetes necesarios
   ...
   ````
   sudo pacman -S waybar swaync swayosd polkit-gnome noto-fonts noto-fonts-cjk ttf-jetbrains-mono-nerd swww nwg-drawer clipse hypridle hyprlock flameshot power-profiles-daemon pavucontrol gamemode pacman-contrib reflector qpwgraph appimagelauncher 
   ````
